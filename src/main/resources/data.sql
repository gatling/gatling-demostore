...
VALUES (1,'JWillett','$2a$10$WFVx94AaqAGV2gt3g9ey1OSh2d4Q3B8b5.whnw4JR7b1/dNWECgji');
...
VALUES (1,'Home','home','<h2>Welcome to the Gatling DemoStore!</h2><p>&nbsp;</p><p>This is a fictional / dummy eCommerce store that sells eyeglass cases.</p><p>Since this is a sandbox solution, no actual sales transactions are completed on this site.</p><p>&nbsp;</p><h3><strong>&lt; Select a category from the left-hand menu</strong></h3><p>&nbsp;</p><p>The purpose of this store is to teach the creation of test scripts with the <a href=\"https://gatling.io\">Gatling</a> load testing tool.</p><p>To find out more, check out the <a href=\"https://gatling.io/academy/\">Gatling Academy</a></p>',0),
       (10,'About us','about-us','<h2>About Us</h2><p>&nbsp;</p><p>This is a fictional / dummy eCommerce store that sells eyeglass cases.</p><p>The purpose of this site is to teach the creation of test scripts with the <a href=\"https://gatling.io\">Gatling</a> load testing tool</p><p>&nbsp;</p>',100),
...
VALUES (1,'john','$2a$10$98T7JTswTQ0agIBTs44Tb.NKDOnhXaXMl2GQsovNAx5N0SUDTGBM2','john@gmail.com','11111111'),
       (2,'user1','$2a$10$bBOalN4L9Ha/Qtwe4p5jG.Y7BAJKE0atDLVWY62pplrFhY9ADm90G','user1@email.com','11111111'),
       (3,'user2','$2a$10$APQuj4jTQ0dnFXaTPb.61ejynOla7xlbNZC53o.2yM3w0Z9D.nRsm','user2@email.com','11111111'),
       (4,'user3','$2a$10$s9M5Ch3YBTbwNHGnkeGYquWdb4Psnwzs4hmbzNOozkres0nNXg.rO','user3@email.com','11111111');
